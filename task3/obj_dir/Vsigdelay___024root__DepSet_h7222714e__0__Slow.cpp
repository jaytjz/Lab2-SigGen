...
VL_ATTR_COLD void Vsigdelay___024root___ctor_var_reset(Vsigdelay___024root* vlSelf) {
    ...
    vlSelf->sigdelay__DOT__count1 = VL_RAND_RESET_I(8);
    vlSelf->sigdelay__DOT__count2 = VL_RAND_RESET_I(8);
    for (int __Vi0=0; __Vi0<256; ++__Vi0) {
        vlSelf->sigdelay__DOT__myDualRam__DOT__ram_array[__Vi0] = VL_RAND_RESET_I(8);
    }
}
